...
if ! command -v rg >/dev/null 2>&1; then
  alias rg='/Users/luca/.nvm/versions/node/v24.4.1/lib/node_modules/\@anthropic-ai/claude-code/vendor/ripgrep/arm64-darwin/rg'
fi
export PATH=/Users/luca/.nvm/versions/node/v24.4.1/bin\:/opt/homebrew/opt/python\@3.13/bin\:/usr/local/bin\:/System/Cryptexes/App/usr/bin\:/usr/bin\:/bin\:/usr/sbin\:/sbin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/local/bin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/bin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/appleinternal/bin\:/opt/homebrew/bin\:/Users/luca/.nvm/versions/node/v24.4.1/bin\:/opt/homebrew/opt/python\@3.13/bin\:/Applications/kitty.app/Contents/MacOS
